...
<div class="wrapper">
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="/" class="brand-link">
			<img src="/assets/img/logo.png" alt="GGO Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
			<span class="brand-text font-weight-light">GGO</span>
		</a>
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				...
				<div class="info">
					<a href="/users/profile" class="d-block"><?= $user['fullname']?></a>
				</div>
			</div>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; <?=date('Y')?> <a href="#">GGO</a>.</strong> All rights reserved.
	</footer>
</div>
<!-- ./wrapper -->
